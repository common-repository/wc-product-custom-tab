<?php
/**
 * Plugin Name: WooCommerce Product Custom Tab
 * Plugin URI: http://wordpressmarket.com/market-item/woocommerce-product-custom-tab/
 ...
 * Author: Ravi Raiya
 * Author URI: http://wordpressmarket.com/market-item/woocommerce-product-custom-tab/
 * Version: 1.0.0
 * Tested up to: 3.6.1
 *
...
?>
	<div id="custom_tab_data" class="panel woocommerce_options_panel">
				<p> this is lite version. it allows you only single tab. you want more tabs and functionality. please buy pro version at following :<br/>
			<a href="http://wordpressmarket.com/market-item/woocommerce-product-custom-tab/">Woocommerce Product Custom Tab Pro</a><br/>
			the Pro version have following :<br/>
			1) unlimited tabs<br/>
			2) Local and Global Tabs<br/>
			2) Rich Text Editor<br/>
			3) Execute short codes<br/>
			4) Default Tab Layout<br/>
			5) Custom Tab order<br/></p>
			Buy Now <a href="http://wordpressmarket.com/market-item/woocommerce-product-custom-tab/">Woocommerce Product Custom Tab Pro</a> in $35 instead of  <strike>$99 </strike><br/>
...
public function add_woo_custom_product_tabs( $tabs ) {
		...
		if ($custom_tab_options['enabled'] != 'no') {
				 if(! empty($custom_tab_options['custom_tab_content'])|| trim($custom_tab_options['custom_tab_content']) !="")
				 {
